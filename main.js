fetch('https://api.covid19api.com/summary')
    ...
    .then((actualdata) => {
            ...
            //confirm
            const mydata = actualdata.Countries[124].TotalConfirmed;
            document.getElementById('conin').innerHTML = mydata;


            //recover
            const recdata = actualdata.Countries[124].TotalRecovered;
            document.getElementById('revin').innerHTML = recdata;

            //deaths
            const detdata = actualdata.Countries[124].TotalDeaths;
